...
```{r}
master_df <- read.csv('C:/Users/Nico/Desktop/Code/Projects/Spotify/master_df_base.csv')
...
```{r}
Sys.setenv(SPOTIFY_CLIENT_ID = 'a443232f235b4939ad31388a6764a9a7')
Sys.setenv(SPOTIFY_CLIENT_SECRET = 'bc79d9db69b14b248f97416671bd7e18')
...
Sys.setenv(SQL_PASSWORD = 'sql')
pg <- dbDriver("PostgreSQL")
driver <- dbDriver("PostgreSQL")
dbconn <- dbConnect(driver, user="niconaut", password=Sys.getenv("SQL_PASSWORD"), host="localhost", port=5432, dbname="spotify")
```
...
```{r}
master_df <- read.csv('C:/Users/Nico/Desktop/Code/Projects/Spotify/master_df.csv')
